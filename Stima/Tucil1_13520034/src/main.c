    ...
    for (i = 0; i < jumlah_kata; i++)
    {
        ...
        while (!found && j < ukuran_matrix)
        {
            ...
            if (matrix[j] == array_all_kata[panjang_all_kata_yang_sudah_ditemukan])
            {
                ...
                {
                    jumlah_perbandingan++;
                    if (j - k * col >= 0 && (j - (j / col) * col + k - col) < 1)
                    {
                        jumlah_perbandingan++;
                ...
                {
                    jumlah_perbandingan++;
                    if ((j - (j / col) * col + k - col) < 1 && j + col * k < col * row)
                    {
                        jumlah_perbandingan++;
                        if (matrix[j + k * col + k] != array_all_kata[panjang_all_kata_yang_sudah_ditemukan + k])
                        {
                ...
                {
                    jumlah_perbandingan++;
                    if (j + col * k < col * row && j - (j / col) * col - k >= 0)
                    {
                        jumlah_perbandingan++;
                        if (matrix[j + k * col - k] != array_all_kata[panjang_all_kata_yang_sudah_ditemukan + k])
                        {
